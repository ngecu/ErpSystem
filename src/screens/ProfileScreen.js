...
{userInfo ? (<> 
    ...
    {/* <SidebarComponent /> */}
      ...
      <Col md={3}>
        ...
        {loading ? (
          ...
          {userInfo?.profile_pic &&     <Col md={12}>
                  ...
                  { userInfo.profile_pic.includes("https") ? <img className="avatar-img  border border-white border-3 shadow" style={{width:"100%",height:"200px"}} src={`${userInfo.profile_pic}`} alt=""/> : <img className="avatar-img border border-white border-3 shadow" src={`https://text-image-backend.onrender.com${userInfo.profile_pic}`} style={{width:"100%",height:"200px"}} alt=""/> }
      ...
      <Col md={9}>
        ...
        <table className="table w-100 table-dark-gray align-middle p-4 mb-0">
						<thead>
							<tr>
                ...
                <Link to={`/new_story`} className="btn btn-success mb-0">
							Create an article
          </Link>
						...
						<tbody>		
							...
							<td>
							<span className="badge bg-primary bg-opacity-10 text-light">{new Date(`${article.createdAt}`).toLocaleString()}</span>
							</td>
		...
		<div className="row align-items-center g-5">
			...
			<div className="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
					...
					<Link to='/login' className="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">Get Started</Link>
{/* 					
			...
			<div className="col-lg-7 col-xl-6 text-center position-relative">
				...
				<figure className="position-absolute bottom-0 start-50 translate-middle-x mb-n5 z-index-9">
					...
					<path className="fill-body" d="M60.9,0L0.1,0C0,0,0,0,0,0.1c1.5,5,0,249.5,11.5,297.9c0,0,649.1,16.1,669-4.6c0,0,0,0,0,0c0.2-0.4,1.2-177.2,4.2-293.3 c0,0,0-0.1-0.1-0.1l-72.9,0c0,0-0.1,0-0.1,0c-0.8,3-43.3,162.3-105.9,209.1c0,0-111.4,87.2-309.9-6C195.9,203.1,66.1,143.2,60.9,0 C61,0,60.9,0,60.9,0z"></path>
					</svg>
				</figure>
		...
		<div className="row g-4">
				...
				<div className="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
					...
					<div className="ms-4 h6 fw-normal mb-0">
						<div className="d-flex">
							<h5 className="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="10" data-purecounter-delay="200" data-purecounter-duration="0"></h5>
			...
			<div className="col-sm-6 col-xl-3">
				<div className="d-flex justify-content-center align-items-center p-4 bg-blue bg-opacity-10 rounded-3">
					...
					<div className="ms-4 h6 fw-normal mb-0">
						<div className="d-flex">
							<h5 className="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="200" data-purecounter-delay="200" data-purecounter-duration="0"></h5>
							<span className="mb-0 h5"></span>
						</div>
						<p className="mb-0">Aricles</p>
					</div>
				</div>
			</div>
			...
			<div className="col-sm-6 col-xl-3">
				<div className="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
					...
					<div className="ms-4 h6 fw-normal mb-0">
						<div className="d-flex">
							<h5 className="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="60" data-purecounter-delay="200" data-purecounter-duration="0"></h5>
							<span className="mb-0 h5"></span>
						</div>
			...
			<div className="col-sm-6 col-xl-3">
				<div className="d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3">
					...
					<div className="ms-4 h6 fw-normal mb-0">
						<div className="d-flex">
							<h5 className="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="6" data-purecounter-delay="300" data-purecounter-duration="0"></h5>
							<span className="mb-0 h5"></span>
						</div>
